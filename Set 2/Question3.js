// Given employee’s data, write an ES6 function which 
// greets them with a personalized message for onboarding.
...
const greetEmployeeMessages =(arr)=> arr.map(({name,dept}) => (`Hi ${name} we are glad to have you as a ${dept}`));
